...
namespace Bush
{
    public class BushBlackBoard : Blackboard
    {
    ...
    public static class AnimHash
    {
        ...
        public static readonly int Shock = Animator.StringToHash("Skill");
    }
    public class IdleState : IState
    {
        private FSM fsm;
        private BushBlackBoard bb;
        public IdleState(FSM fsm)
        {
            this.fsm = fsm;
            bb = fsm.blackboard as BushBlackBoard;
        }
    ...
    {
        private BushBlackBoard blackboard;
        private FSM fsm;
    ...
    public class CheckDistanceNode : ConditionNode
    {
        ...
        {
            BushBlackBoard bb = blackboard as BushBlackBoard;
    ...
    {
        public CheckHitNode(BushBlackBoard bb) : base(bb) { }
    ...
    {
        public CheckDeathNode(BushBlackBoard bb) : base(bb) { }
